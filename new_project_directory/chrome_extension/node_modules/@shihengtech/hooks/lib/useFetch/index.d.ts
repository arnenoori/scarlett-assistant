...
import { PromiseReturnType } from '@shihengtech/hooks/lib/utils';
...
export default function useFetch<T extends (...args: any[]) => any>(func: T, deps?: DependencyList, { auto, onError, onSuccess, initialState }?: IUseFetchOptions<T>): {
    setState: import("react").Dispatch<import("react").SetStateAction<IUseFetchState<import("@shihengtech/hooks/lib/utils").Unpack<ReturnType<T>>>>>;
    loading: boolean;
    params?: Parameters<T> | undefined;
    data?: import("@shihengtech/hooks/lib/utils").Unpack<ReturnType<T>> | undefined;
    error?: any;
