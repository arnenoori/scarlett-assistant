...
import uriTransformer = require('react-markdown/src/uri-transformer.js')
type ReactNode = import('react').ReactNode
type PluggableList = import('unified').PluggableList
type Root = import('hast').Root
type FilterOptions = import('react-markdown/src/rehype-filter.js').RehypeFilterOptions
type TransformOptions = import('react-markdown/src/ast-to-react.js').TransformOptions
type CoreOptions = {
  children: string
}
type PluginOptions = {
