import { ISchema, SchemaEnum, SchemaProperties, SchemaReaction, SchemaTypes, SchemaKey, ISchemaTransformerOptions } from '@formily/json-schema/esm/types';
...
export declare class Schema<Decorator = any, Component = any, DecoratorProps = any, ComponentProps = any, Pattern = any, Display = any, Validator = any, Message = any, ReactionField = any> implements ISchema {
    ...
    static registerPatches: (...args: import("@formily/json-schema/esm/types").SchemaPatch[]) => void;
    static registerVoidComponents: (components: string[]) => void;
    static registerTypeDefaultComponents: (maps: Record<string, string>) => void;
    static registerPolyfills: (version: string, patch: import("@formily/json-schema/esm/types").SchemaPatch) => void;
