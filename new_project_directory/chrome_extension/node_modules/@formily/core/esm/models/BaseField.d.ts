...
import { LifeCycleTypes, FieldDisplayTypes, FieldPatternTypes, FieldDecorator, FieldComponent, IFieldActions } from '@formily/core/esm/types';
...
export declare class BaseField<Decorator = any, Component = any, TextType = any> {
    ...
    get parent(): import("@formily/core/esm/types").GeneralField;
