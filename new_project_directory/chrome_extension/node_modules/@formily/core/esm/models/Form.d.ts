...
import { Heart } from '@formily/core/esm/models/Heart';
import { Field } from '@formily/core/esm/models/Field';
import { HeartSubscriber, FormPatternTypes, IFormRequests, IFormFeedback, ISearchFeedback, IFormGraph, IFormProps, IFieldResetOptions, IFormFields, IFieldFactoryProps, IVoidFieldFactoryProps, IFormState, IModelGetter, IModelSetter, IFieldStateGetter, IFieldStateSetter, FormDisplayTypes, IFormMergeStrategy } from '@formily/core/esm/types';
import { ArrayField } from '@formily/core/esm/models/ArrayField';
import { ObjectField } from '@formily/core/esm/models/ObjectField';
import { VoidField } from '@formily/core/esm/models/VoidField';
import { Query } from '@formily/core/esm/models/Query';
import { Graph } from '@formily/core/esm/models/Graph';
export declare class Form<ValueType extends object = any> {
    ...
    get lifecycles(): import("@formily/core/esm/models/LifeCycle").LifeCycle<any>[];
    get hidden(): boolean;
    get visible(): boolean;
